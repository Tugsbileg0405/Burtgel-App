            ...
            '<div class="filter-bar-wrapper filter-bar-{{::config.theme}} filter-bar-transition-{{::config.transition}}">' +
              '<div class="bar bar-header bar-{{::config.theme}} item-input-inset">' +
                ...
                '<label class="item-input-wrapper">' +
                  ...
                  '<button class="filter-bar-clear button button-clear button-icon icon" ng-class="getClearButtonClass()"></button>' +
                '</label>' +
              '</div>' +
            '</div>';
        } else {
            ...
            '<div class="filter-bar-wrapper filter-bar-{{::config.theme}} filter-bar-transition-{{::config.transition}}">' +
              '<div class="bar bar-header bar-{{::config.theme}} item-input-inset">' +
                '<label class="item-input-wrapper">' +
                  ...
                  '<button class="filter-bar-clear  button button-clear button-icon icon"   ng-class="getClearButtonClass()"></button>' +
                '</label>' +
                '<button class="filter-bar-cancel button button-clear" style="color:black;font-size:16px" ng-bind-html="::cancelText"></button>' +
              '</div>' +
            '</div>';
        }
